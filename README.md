...
- **Data Visualization** - View your health progress with intuitive charts
...
- Ensure you have an active internet connection for dependency downloads

### Installation

1. **Clone the Repository**
   ```bash
   git clone https://github.com/MyHorizonTeam/Pulse-HealthTracker.git
   cd Pulse-HealthTracker
   ```
...
3. **Start Tracking** - Log your health metrics and activities
